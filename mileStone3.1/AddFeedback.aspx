...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
           <asp:Button ID="Button5" runat="server" Text="View My Profile" OnClick="ViewProfile" />
            <br />
         
            <asp:Button ID="Button3" runat="server" Text="Add Credit Card" OnClick="AddCreditCard" />
            <br />
            <asp:Button ID="Button4" runat="server" Text="View All Courses" OnClick="ViewCourses" />
            <br />
            ...
            <br />
            <asp:Button ID="Button2" runat="server" Text="View List Of Certificates" OnClick="ListCertificates" />
